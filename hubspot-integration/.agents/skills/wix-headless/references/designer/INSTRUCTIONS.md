...
.btn-primary {
  @apply btn bg-amber;
} /* btn is a custom class */
.faq-section {
  @apply section container-reading;
} /* both custom */
```
...
.btn-primary {
  @apply btn bg-amber text-walnut;
} /* now OK */
.btn-secondary {
  @apply btn border border-rule text-paper;
} /* now OK */
.btn-ghost {
  @apply btn bg-transparent text-ink hover:bg-paper-warm;
} /* now OK */
```
...
} /* @utility btn was not declared above */
```
